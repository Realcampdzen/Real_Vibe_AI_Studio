...
const SERVICES_DATA = [
  ...
  },
  {
    ...
    heroVideo: serviceAsset('agentic-ai-dev', 'agent-office-loop.mp4'),
    heroMobileVideo: serviceAsset('agentic-ai-dev', 'agent-office-loop-mobile.mp4'),
    heroPoster: serviceAsset('agentic-ai-dev', 'cover-hermes-office-2026.jpg'),
    detailMedia: [
      videoMedia('agentic-ai-dev', 'agent-office-loop.mp4', 'cover-hermes-office-2026.jpg', 'Hermes agents office live', 'Лёгкий loop из записи экрана: живой офис агентов, роли, рабочие зоны и product workflow.'),
