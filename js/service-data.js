...
const SERVICES_DATA = [
  ...
  },
  {
    ...
    price: 'от 4 000₽',
    backgroundImage: serviceAsset('agentic-ai-dev', 'cover.jpg'),
    avatarImage: serviceAsset('agentic-ai-dev', 'detail-1.jpg'),
    heroVideo: '',
    heroPoster: serviceAsset('agentic-ai-dev', 'teaser-poster.jpg'),
    detailMedia: [
      imageMedia('agentic-ai-dev', 'cover.jpg', 'Agentic control plane', 'Санитизированный proof-скрин: рабочая система задач, лидов и AI-assisted разработки.'),
