...
const SERVICES_DATA = [
  {
    ...
    description: 'Создаём рекламные ролики, товарные Reels, клипы и вертикальные видео на базе AI-инструментов с режиссурой, монтажом и звуком.',
    features: [
      'Концепция и сценарий под товар, упаковку, этикетку или услугу',
    ...
    lead: 'Делаем ролики, которые выглядят как полноценный продакшн, но собираются быстрее и гибче за счёт AI-инструментов. Входной формат подходит для рекламы товара, упаковки или этикетки; более сложные ролики собираем через несколько нейросетей, монтаж, звук и подготовку форматов под площадки.',
    ...
    formats: ['Вертикальные ролики 9:16', 'Горизонтальные промо 16:9', 'Товарные ролики: упаковка, этикетка, продукт', 'Короткие рекламные cut-down версии', 'Постеры и кадры для баннеров'],
    whatYouGet: [
      'Готовый ролик под нужные площадки.',
      'Пакет постеров и кадров для промо.',
      'Возможность масштабировать концепцию в серию роликов.',
    ],
    offersTitle: 'Пакеты роликов',
    offers: [
      { id: 'product-ad-reel', title: 'Товарный ролик / Reels', price: 'от 9 000₽', description: 'Короткий рекламный ролик для товара, упаковки, этикетки или простой промо-задачи.' },
      { id: 'multi-model-reel', title: 'Ролик длиннее и сложнее', price: '15 000₽', description: 'Больше сцен, длиннее хронометраж и сборка через несколько нейросетей.' },
      { id: 'complex-edit-15-25', title: 'Сложный ролик 15-25 сек', price: '30 000₽', description: 'Сценарий, несколько сцен, монтаж, доводка, звук и версии под площадки.' },
      { id: 'custom-production', title: 'Серия / спецпроект', price: 'индивидуально', description: 'Когда нужен клип, серия роликов, персонажи, сложная графика, продюсирование или пакет запусков.' },
    ],
  },
  {
    id: 1,
