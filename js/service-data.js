...
const SERVICES_DATA = [
  ...
  },
  {
    ...
    description: 'Проектируем и разрабатываем MVP, SaaS, CRM, дашборды и приложения с AI-логикой, ролями, базой данных и понятным путём к релизу.',
    features: [
    ...
    seoDescription: 'Разработка MVP, SaaS, CRM, дашбордов и приложений с AI-функциями, базой данных, ролями пользователей и деплоем.',
    buttonText: 'Обсудить MVP',
    buttonIcon: 'fab fa-telegram',
    detailTitle: 'MVP, SaaS и приложения с AI-функциями',
    lead: 'Берём идею, сырой прототип или уже начатый AI-код и доводим до рабочего продукта: архитектура, интерфейс, backend, база данных, роли, деплой и безопасный первый релиз.',
  ...
  },
  {
    ...
    description: 'Делаем сайты, лендинги и веб-сервисы с современным дизайном, быстрым frontend, формами, аналитикой, AI-чатом и интеграциями.',
    features: [
    ...
    seoDescription: 'Разработка лендингов, сайтов, веб-сервисов, личных кабинетов и AI-функций на React, Next.js и современных API.',
    buttonText: 'Обсудить сайт',
    buttonIcon: 'fab fa-telegram',
    detailTitle: 'Сайты, лендинги и веб-сервисы с AI-функциями',
    lead: 'Собираем цифровую витрину или веб-сервис так, чтобы он был не только красивым, но и рабочим: структура, адаптивный UI, заявки, интеграции, AI-ассистент и понятный путь пользователя.',
  ...
  },
  {
    ...
    detailMedia: [
      ...
      imageMedia('creative-production', 'dominia-key-visual.png', 'Key visual DOMINIA', 'Группа, портал и визуальный код проекта в одном cinematic-кадре.'),
  ...
  },
  {
    ...
    description: 'Agentic full-stack разработка под ключ: беру идею, сырой прототип или сломанный AI-код и довожу до стабильного релиза.',
    features: [
    ...
    seoDescription: 'Agentic full-stack разработка: MVP, SaaS, Telegram Mini Apps, AI-боты, стабилизация Cursor/Lovable/v0 и production-ready AI-код.',
    buttonText: 'Разобрать задачу',
    buttonIcon: 'fab fa-telegram',
    detailTitle: 'Agentic Full-Stack Developer / Вайбкодер',
    lead: 'Я не просто генерирую код через нейросети. Проектирую архитектуру, стабилизирую AI-код и довожу сложные веб-проекты до рабочего релиза: frontend, backend, база, API, деплой и понятный следующий этап.',
