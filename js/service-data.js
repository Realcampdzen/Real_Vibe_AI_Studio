...
const SERVICES_DATA = [
  ...
  },
  {
    ...
    price: 'от 15 000₽',
    backgroundImage: serviceAsset('sound-design', 'cover-modern-studio.png'),
  ...
  },
  {
    ...
    backgroundImage: serviceAsset('apps', 'cover-business-apps-2026.png'),
  ...
  },
  {
    ...
    price: 'от 10 000₽',
    backgroundImage: serviceAsset('bots', 'cover-bot-workflow-clean-2026.png'),
    avatarImage: serviceAsset('bots', 'cover-bot-workflow-clean-2026.png'),
    heroVideo: '',
    heroPoster: serviceAsset('bots', 'cover-bot-workflow-clean-2026.png'),
    detailMedia: [
      imageMedia('bots', 'cover-bot-workflow-clean-2026.png', 'Диалоговые сценарии', 'Ветки, ответы и логика, которые ведут пользователя к действию.'),
  ...
  },
  {
    ...
    cardBenefit: 'VPS, MVP, SaaS, Android/PWA, доставка, 1С, AI-боты и стабилизация AI-кода',
    description: 'Agentic full-stack разработка под ключ: беру идею, сырой прототип или сломанный AI-код и довожу до стабильного релиза с Open Design, Codex, GPT Pro, Android/PWA-оболочкой и собственным VPS-контуром.',
    features: [
    ...
    formats: ['Open Design / Codex / GPT Pro', 'React / Next.js / TypeScript', 'PWA / Android TWA / Capacitor', 'FastAPI / Django / Node.js', 'Timeweb VPS / PostgreSQL / Supabase / Docker / Vercel', 'OpenAI API / Telegram Bot API'],
    whatYouGet: [
