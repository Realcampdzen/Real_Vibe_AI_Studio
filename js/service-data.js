...
const SERVICES_DATA = [
  ...
  },
  {
    ...
    cardTitle: 'MAX BUSINESS, БОТЫ И MINI APPS',
    cardBenefit: 'Подключение ИП/ООО, канал, до 5 ботов, mini app и AI-агент на VPS',
    description: 'Запускаем бизнес в MAX: помогаем пройти старт с MAX Business, собрать канал, подключить ботов, mini app, прием заявок и AI-агента на VPS.',
    features: [
      'MAX Business setup для ИП/ООО',
      'Канал, первый бот и план до 5 ботов под роли',
      'Mini app: каталог, квиз, заявка, запись или витрина',
      'Webhook, VPS, Hermes/AI-agent и безопасные границы действий',
      'Маршрут лида в Telegram/MAX, таблицу, CRM или Hermes/Kanban',
    ],
    price: 'от 7 000₽; AI-агент от 15 000₽',
    backgroundImage: serviceAsset('agentic-ai-dev', 'hero-command-center.jpg'),
    avatarImage: serviceAsset('apps', 'cover-business-apps-2026.png'),
    heroVideo: '',
    heroPoster: serviceAsset('agentic-ai-dev', 'hero-command-center.jpg'),
    detailMedia: [
      imageMedia('agentic-ai-dev', 'hero-command-center.jpg', 'MAX как вход в agentic workflow', 'MAX становится понятной точкой входа, а VPS/Hermes забирают обработку, статусы и AI-логику.'),
      imageMedia('apps', 'cover-business-apps-2026.png', 'Mini app и мобильная витрина', 'Каталог, квиз, заявка или запись внутри мобильного сценария вместо длинной переписки.'),
      imageMedia('bots', 'cover-bot-workflow-clean-2026.png', 'Боты и заявки', 'Сценарии сообщений, кнопки, сбор контактов и передача результата менеджеру или в CRM.'),
    ],
    relatedServiceIds: [11, 7, 6],
    seoTitle: 'MAX Business, боты, mini apps и AI-агенты | Реальный Vайб AI Studio',
    seoDescription: 'Подключение MAX Business для ИП/ООО, канал, до 5 ботов, mini app, заявки, webhook, VPS и AI-агент под бизнес-процесс.',
    buttonText: 'Собрать MAX-воронку',
    buttonIcon: 'fas fa-diagram-project',
    buttonHref: 'max-funnel.html#lead-quiz',
    cartDisabled: true,
    ctaNextStep: 'Первый шаг - пройти мини-квалификацию MAX-воронки и понять, что запускать первым: Business setup, бота, mini app или AI-агента.',
    detailTitle: 'MAX Business и AI-воронка внутри российского мессенджера',
    lead: 'Это отдельный продукт на стыке business setup, mini app, ботов и агентской разработки. Клиент начинает с подключения своего MAX Business-аккаунта к ИП или ООО, а дальше получает канал, первый бот, карту до 5 ботов, mini app и при необходимости AI-агента на VPS.',
    useCasesTitle: 'Кому это подходит',
    useCases: [
      { title: 'Бизнес хочет зайти в MAX первым', description: 'Нужен официальный старт: профиль организации, канал, понятная точка входа для клиентов и быстрый первый сценарий заявок.' },
      { title: 'Есть Telegram-бот или канал', description: 'Разбираем текущую логику, переносим ключевые сценарии в MAX и честно фиксируем ограничения платформ.' },
      { title: 'Нужна мобильная витрина без отдельного приложения', description: 'Mini app закрывает каталог, квиз, форму заявки, запись, прайс или MVP-экран внутри мессенджера.' },
      { title: 'Нужен AI-агент, а не обычный FAQ-бот', description: 'Сообщения идут через webhook на VPS, агент работает по роли, базе знаний и allowlist, а критичные действия остаются под контролем владельца.' },
    ],
    whatWeDoTitle: 'Как устроен запуск',
    whatWeDo: [
      { title: 'Проверяем MAX Business старт', description: 'Смотрим готовность ИП/ООО, сайт, контакты, описание, канал, роли и безопасный порядок передачи доступов.' },
      { title: 'Проектируем первый контур', description: 'Фиксируем, что запускаем первым: канал, бот заявок, mini app, AI-агент или перенос из Telegram.' },
      { title: 'Собираем ботов и mini app', description: 'Готовим сценарии сообщений, кнопки, формы, каталог, квиз, заявки и инструкции для эксплуатации.' },
      { title: 'Подключаем VPS/AI слой', description: 'Для агентского сценария настраиваем webhook, env-секреты, health-check, allowlist и связь с Hermes/AI gateway.' },
      { title: 'Проводим smoke и передаем систему', description: 'Проверяем сообщения, заявки, статусы, fallback и handoff: где лежат настройки, как менять тексты и что развивать дальше.' },
    ],
    formatsTitle: 'Пакеты и форматы',
    formats: ['MAX Business setup', 'MAX bot pack', 'MAX mini app', 'AI-агент в MAX на VPS', 'Telegram -> MAX migration', 'MAX funnel under key'],
    whatYouGet: [
      'Официально подготовленный старт в MAX для вашего бизнеса, без передачи секретов в открытые чаты.',
      'Карту воронки: канал, боты, mini app, заявки, интеграции и следующий AI-апселл.',
      'Рабочий первый сценарий, который можно показать клиентам и развивать без пересборки с нуля.',
      'Понятные ограничения: модерация MAX, внешние API, VPS, CRM и действия AI-агента не обещаются как магия.',
    ],
    offersTitle: 'MAX-офферы',
    offers: [
      { id: 'max-business-setup', title: 'MAX Business Setup', price: 'от 7 000₽', description: 'Подготовка Business-профиля, канала, стартовой структуры и карты запуска под ИП/ООО.' },
      { id: 'max-bot-pack', title: 'MAX Bot Pack', price: 'от 12 000₽', description: 'Бот для заявок, FAQ, кнопок, контактов и уведомлений менеджеру.' },
      { id: 'max-mini-app', title: 'MAX Mini App', price: 'от 24 000₽', description: 'Mini app с каталогом, квизом, формой заявки, записью или MVP-витриной.' },
      { id: 'max-ai-agent-vps', title: 'MAX AI Agent on VPS', price: 'от 15 000₽ старт', description: 'Webhook, VPS-адаптер, AI/Hermes роль, allowlist, health-check и smoke-тест.' },
      { id: 'telegram-max-migration', title: 'Telegram -> MAX Migration', price: 'от 15 000₽', description: 'Аудит Telegram-бота/канала и перенос ключевых сценариев, текстов, кнопок и заявок в MAX.' },
      { id: 'max-funnel-under-key', title: 'MAX Funnel Under Key', price: 'от 45 000₽ MVP', description: 'Business setup, канал, бот, mini app, маршрут заявок и интеграция с таблицей, CRM или Hermes.' },
    ],
    proofPointsTitle: 'Что уже доказано',
    proofPoints: [
      'Собственный MAX Business Real Vibe подтвержден и используется как канал продаж.',
      'НейроСтепа подключен в MAX как рабочий бот с ответами через существующий agentic-контур.',
      'Архитектура умеет связывать MAX webhook, VPS-оператора, Hermes/AI-агента и ответ пользователю.',
      'Локально подготовлены товарные карточки, тексты, обложки и интерактивная квалификация лида.',
    ],
    caseStudiesTitle: 'Как это продаем',
    caseStudies: [
      {
        title: 'MAX как новый вход в agentic ecosystem',
        description: 'Сначала клиент подключает свой MAX Business к ИП/ООО, затем получает канал, бот и mini app. После этого логично продавать AI-агента на VPS за 15 000₽+ как следующий слой.',
        points: ['Business-first старт', 'до 5 ботов под роли', 'mini app как мобильная витрина', 'AI/VPS как апселл'],
      },
    ],
  },
];
