(function exposeServicePriceOverrides() {
  ...
  "services": {
    "ai-video": {
      ...
      "price": "от 80 000₽",
      "note": "Бутик-премиум: короткий рекламный AI-ролик с концепцией, сценами, монтажом и звуком."
    },
    "ai-photo": {
    ...
    "apps": {
      ...
      "note": "Первый production-ready модуль: архитектура, база/API, роли или дашборд."
    },
    "bots": {
    ...
    "agentic-ai-dev": {
      ...
      "note": "Публичный якорь для разработки; маленький аудит вынесен в отдельный rescue-оффер."
    }
  },
  "offers": {
    "agentic-ai-dev": {
