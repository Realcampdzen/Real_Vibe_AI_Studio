...
// Версия кэша
const CACHE_VERSION = 'v2.42-20260523-mono-nav-poster-cards';
...
const STATIC_ASSETS = [
  ...
  withBase('/css/style.css?v=20260523-mono-nav-poster-cards'),
  ...
  withBase('/js/script.js?v=20260523-mono-nav-poster-cards'),
  ...
  withBase('/js/auth-cart.js?v=20260523-mono-nav-poster-cards'),
