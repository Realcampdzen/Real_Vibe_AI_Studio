...
// Версия кэша
const CACHE_VERSION = 'v2.49-20260611-max-channel-scale';
...
const STATIC_ASSETS = [
  ...
  withBase('/public/icons/icon-512.png?v=20260520-android-hotfix'),
  withBase('/public/icons/maskable-512.png'),
  withBase('/public/icons/maskable-512.png?v=20260520-android-hotfix'),
  ...
  withBase('/css/style.css?v=20260611-max-channel-scale'),
  ...
  withBase('/css/mobile-improvements.css?v=20260611-max-channel-scale'),
  ...
  withBase('/js/script.js?v=20260611-max-channel-scale'),
  withBase('/js/page-common.js?v=20260611-max-channel-scale'),
  ...
  withBase('/js/service-data.js?v=20260603-ai-video-price-ladder'),
  withBase('/js/service-detail-page.js?v=20260521-portfolio-profile'),
  withBase('/js/admin-prices.js?v=20260603-ai-video-price-ladder'),
  ...
  withBase('/public/works/services/agentic-ai-dev/codex-tax-agent-process-codex-office-20260603.jpg'),
  withBase('/public/works/services/agentic-ai-dev/codex-tax-agent-process-codex-office-mobile-20260603.jpg'),
  withBase('/public/works/services/agentic-ai-dev/codex-tax-agent-process-fns-reporting-20260603.jpg'),
  withBase('/public/works/services/agentic-ai-dev/codex-tax-agent-process-fns-reporting-mobile-20260603.jpg'),
  withBase('/public/works/services/agentic-ai-dev/codex-tax-agent-process-okved-20260603.jpg'),
  withBase('/public/works/services/agentic-ai-dev/codex-tax-agent-process-okved-mobile-20260603.jpg'),
