...
// Версия кэша
const CACHE_VERSION = 'v2.43-20260523-matte-card-labels';
...
const STATIC_ASSETS = [
  ...
  withBase('/css/style.css?v=20260523-matte-card-labels'),
  ...
  withBase('/js/script.js?v=20260523-matte-card-labels'),
