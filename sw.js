...
// Версия кэша
const CACHE_VERSION = 'v2.46-20260523-smoky-teal-labels';
...
const STATIC_ASSETS = [
  ...
  withBase('/css/style.css?v=20260523-smoky-teal-labels'),
  ...
  withBase('/js/script.js?v=20260523-smoky-teal-labels'),
