...
// Версия кэша
const CACHE_VERSION = 'v2.47-20260523-frosted-glass-labels';
...
const STATIC_ASSETS = [
  ...
  withBase('/css/style.css?v=20260523-frosted-glass-labels'),
  ...
  withBase('/js/script.js?v=20260523-frosted-glass-labels'),
