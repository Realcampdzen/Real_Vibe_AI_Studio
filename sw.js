...
// Версия кэша
const CACHE_VERSION = 'v2.43-20260603-codex-office-case';
...
const STATIC_ASSETS = [
  ...
  withBase('/css/style.css?v=20260603-codex-office-case'),
  ...
  withBase('/js/script.js?v=20260603-codex-office-case'),
  ...
  withBase('/js/service-data.js?v=20260603-codex-office-case'),
