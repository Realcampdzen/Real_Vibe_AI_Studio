...
// Версия кэша
const CACHE_VERSION = 'v2.40-20260523-remove-ambient-lab';
...
const STATIC_ASSETS = [
  ...
  withBase('/css/style.css?v=20260523-remove-ambient-lab'),
  ...
  withBase('/js/script.js?v=20260523-remove-ambient-lab'),
